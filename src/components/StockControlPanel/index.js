...
export default class StockControlPanel extends PureComponent {
    ...
    render () {
        return (
            <div className='stock__control_panel'>
                <SecuritySelectorComponent onAdd={ this.props.onAddSecurity } />

                {!!this.props.children && <div className='stock__control_panel__separator'>&nbsp;</div>}
                {this.props.children}
                
                <div className='stock__control_panel__separator'>&nbsp;</div>
                <div className='stock__control_panel__btn' 
